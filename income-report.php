    ...
    <div class="card-body">
      <div class="d-flex justify-content-center col-md-12">
        <ul class="nav nav-tabs">
          <li class="nav-item">
            <a class="nav-link active" href="income-report.php">Gelir Raporu</a>
          </li>

          <li class="nav-item">
            <a class="nav-link " href="expenses-report.php">Gider Raporu</a>
          </li>
        </ul>  
      </div>
      ...
      $sql=$db->prepare("
        ...
        SUM(income_price) FROM income GROUP BY 
        income_category
        ");
      $sql->execute();
