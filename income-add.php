      ...
      <div>
        ...
        <form action="netting/islem.php" method="POST" class="needs-validation" novalidate>
          <div class="input-group mb-3 mt-3">
            ...
            <input type="number" pattern="\d*" required class="form-control" name="income_price">
            <span class="input-group-text">.00</span>
          </div>


          <div class="mb-3">
            <input  type="" name="income_category" class="form-control" required placeholder="Kategori Seçin" list="dataListOption" id="kategoriDataList">

            <datalist id="dataListOption">
              <option value="Maaş">
                <option value="Sabo Software">
                  <option value="TwitchTrendleri">
                    <option value="Görevcim">
                      <option value="Peder"> 
                      </datalist>
                    </div>
                    ...
                    <div class="mt-3">
                      <button type="submit" name="income_add" class="btn btn-outline-secondary w-100 btn-lg"><i class="bi bi-plus"></i> Gelir Ekle</button>
                    </div>
